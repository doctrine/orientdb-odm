...
class BindingParametersTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Congow\Orient\Binding\BindingParameters', BindingParameters::create(array()));
        $this->assertInstanceOf('Congow\Orient\Binding\BindingParameters', BindingParameters::create(''));
