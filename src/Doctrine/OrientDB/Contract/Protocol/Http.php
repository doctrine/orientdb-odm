 ...
 * See: http://code.google.com/p/orient/wiki/Doctrine\OrientDBDB_REST
 *
...
namespace Doctrine\OrientDB\Contract\Protocol;

use Doctrine\OrientDB\Contract\Http\Client;
...
interface Http
{
    ...
    /**
     * Opens a connection to an Doctrine\OrientDBDB $database.
     *
     * @param   string  $database
     * @return  mixed
     */
    ...
    /**
     * Disconnects the client from the Doctrine\OrientDBDB database, if any connection
     * is still open.
     *
     * @return  mixed
     */
    ...
    /**
     * Retrieves informations about the running Doctrine\OrientDBDB server instance.
     *
     * @return  mixed
     */
     ...
     * Since almost all the methods exposed by Doctrine\OrientDBDB HTTP interface let you
