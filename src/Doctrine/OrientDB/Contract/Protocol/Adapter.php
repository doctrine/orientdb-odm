...
/**
 * Interface Adapter defines the methods a protocol binding for Doctrine\OrientDB needs to
...
{
    /**
     * Executes a command against Doctrine\OrientDBDB thorugh the protocol binding,
     ...
     * @throws Doctrine\OrientDB\Exception\Http\Response\Void
     * @return boolean
     */
