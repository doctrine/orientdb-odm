...
use Doctrine\Orient\Query\Command\Credential\Grant;
use Doctrine\Orient\Query\Command\Credential\Revoke;
use Doctrine\Orient\Query\Command\Insert;
use Doctrine\Orient\Query\Command\Select;
use Doctrine\Orient\Exception;
use Doctrine\Orient\Contract\Query as QueryInterface;
use Doctrine\Orient\Contract\Query\Command\Select as SelectInterface;
use Doctrine\Orient\Contract\Query\Command\Insert as InsertInterface;
use Doctrine\Orient\Contract\Query\Command\Grant as GrantInterface;
use Doctrine\Orient\Contract\Query\Command\Revoke as RevokeInterface;

class Query implements QueryInterface
{
    protected $command = null;
    protected $commands = array(
        'select'            => 'Doctrine\Orient\Query\Command\Select',
        'insert'            => 'Doctrine\Orient\Query\Command\Insert',
        'delete'            => 'Doctrine\Orient\Query\Command\Delete',
        'update'            => 'Doctrine\Orient\Query\Command\Update',
        'update.add'        => 'Doctrine\Orient\Query\Command\Update\Add',
        'update.remove'     => 'Doctrine\Orient\Query\Command\Update\Remove',
        'update.put'        => 'Doctrine\Orient\Query\Command\Update\Put',
        'grant'             => 'Doctrine\Orient\Query\Command\Credential\Grant',
        'revoke'            => 'Doctrine\Orient\Query\Command\Credential\Revoke',
        'class.create'      => 'Doctrine\Orient\Query\Command\OClass\Create',
        'class.drop'        => 'Doctrine\Orient\Query\Command\OClass\Drop',
        'class.alter'       => 'Doctrine\Orient\Query\Command\OClass\Alter',
        'truncate.class'    => 'Doctrine\Orient\Query\Command\Truncate\OClass',
        'truncate.cluster'  => 'Doctrine\Orient\Query\Command\Truncate\Cluster',
        'truncate.record'   => 'Doctrine\Orient\Query\Command\Truncate\Record',
        'references.find'   => 'Doctrine\Orient\Query\Command\Reference\Find',
        'property.create'   => 'Doctrine\Orient\Query\Command\Property\Create',
        'property.drop'     => 'Doctrine\Orient\Query\Command\Property\Drop',
        'property.alter'    => 'Doctrine\Orient\Query\Command\Property\Alter',
        'index.drop'        => 'Doctrine\Orient\Query\Command\Index\Drop',
        'index.create'      => 'Doctrine\Orient\Query\Command\Index\Create',
        'index.count'       => 'Doctrine\Orient\Query\Command\Index\Count',
        'index.put'         => 'Doctrine\Orient\Query\Command\Index\Put',
        'index.remove'      => 'Doctrine\Orient\Query\Command\Index\Remove',
        'index.lookup'      => 'Doctrine\Orient\Query\Command\Index\Lookup',
        'link'              => 'Doctrine\Orient\Query\Command\Link',
    );
