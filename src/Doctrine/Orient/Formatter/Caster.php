...
namespace Doctrine\Orient\Formatter;

use Doctrine\Orient\Contract\Formatter\Caster as CasterInterface;
...
use Doctrine\Orient\ODM\Proxy;
use Doctrine\Orient\ODM\Proxy\Collection as CollectionProxy;
use Doctrine\Orient\ODM\Proxy\Value as ValueProxy;
...
class Caster implements CasterInterface
{
     ...
     * @throws Doctrine\Orient\Exception\Casting\Mismatch
     * @return mixed
     */
