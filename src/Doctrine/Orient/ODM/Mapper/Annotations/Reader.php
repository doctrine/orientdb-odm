...
/**
 * Class used in order to decouple Doctrine\Orient from the Doctrine dependency.
...
use Doctrine\Orient\Contract\ODM\Mapper\Annotations\Reader as ReaderInterface;
...
class Reader implements ReaderInterface
{
    ...
    public function __construct(Cache $cacheReader = null)
    {
        ...
        AnnotationRegistry::registerAutoloadNamespace("Doctrine\Orient");
