 ...
 * Doctrine\Orient exposes through its HTTP interface.
...
use Doctrine\Orient\Contract\Http\Client;
...
interface Http
{
    ...
    /**
     * Opens a connection to an Doctrine\OrientDB $database.
     *
     * @param   string  $database
     * @return  mixed
     */
    ...
    /**
     * Disconnects the client from the Doctrine\OrientDB database, if any connection
     * is still open.
     *
     * @return  mixed
     */
    ...
    /**
     * Retrieves informations about the running Doctrine\OrientDB server instance.
     *
     * @return  mixed
     */
     ...
     * Since almost all the methods exposed by Doctrine\OrientDB HTTP interface let you
