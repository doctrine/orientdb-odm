...
class Link extends Command
{
    ...
    protected function getTokenFormatters()
    {
        return array_merge(parent::getTokenFormatters(), array(
            'Inverse'               => "Doctrine\Orient\Formatter\Query\Regular",
            'SourceClass'           => "Doctrine\Orient\Formatter\Query\Regular",
            'SourceProperty'        => "Doctrine\Orient\Formatter\Query\Regular",
            'DestinationClass'      => "Doctrine\Orient\Formatter\Query\Regular",
            'DestinationProperty'   => "Doctrine\Orient\Formatter\Query\Regular",
