...
namespace Doctrine\Orient\Query\Command\Reference;

use Doctrine\Orient\Contract\Query\Command\Reference\Find as FindInterface;
...
class Find extends Command implements FindInterface
{
    ...
    protected function getTokenFormatters()
    {
        return array_merge(parent::getTokenFormatters(), array(
            'ClassList'    => "Doctrine\Orient\Formatter\Query\ClassList",
        ));
    }
}
