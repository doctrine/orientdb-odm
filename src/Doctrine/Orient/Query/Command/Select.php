...
class Select extends Command implements SelectInterface
{
    ...
    protected function getTokenFormatters()
    {
        return array_merge(parent::getTokenFormatters(), array(
            'Projections' => "Doctrine\Orient\Formatter\Query\Select",
            'OrderBy'     => "Doctrine\Orient\Formatter\Query\OrderBy",
            'Limit'       => "Doctrine\Orient\Formatter\Query\Limit",
            'Range'       => "Doctrine\Orient\Formatter\Query\Range",
            'Between'     => "Doctrine\Orient\Formatter\Query\Between",
        ));
    }
}
