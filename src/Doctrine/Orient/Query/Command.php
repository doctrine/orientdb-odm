...
namespace Doctrine\Orient\Query;

use Doctrine\Orient\Exception\Query\Command as CommandException;
use Doctrine\Orient\Contract\Formatter\Query as QueryFormatter;
...
use Doctrine\Orient\Contract\Query\Command as CommandContract;
use Doctrine\Orient\Validator\Escaper as EscapeValidator;
...
abstract class Command implements CommandContract
{
    ...
    {
        return array(
            'Target'    => "Doctrine\Orient\Formatter\Query\Target",
            'Where'     => "Doctrine\Orient\Formatter\Query\Where",
            'Class'     => "Doctrine\Orient\Formatter\Query\Regular",
            'Property'  => "Doctrine\Orient\Formatter\Query\Regular",
            'Type'      => "Doctrine\Orient\Formatter\Query\Regular",
            'Rid'       => "Doctrine\Orient\Formatter\Query\Rid",
        );
    }
