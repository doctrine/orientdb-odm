...
use Doctrine\Orient\Contract\Binding\Adapter\HttpClientAdapterInterface;
use Doctrine\Orient\Client\Http\CurlClient;
use Doctrine\Orient\Binding\Adapter\CurlClientAdapter;
use Doctrine\Orient\Exception as OrientException;
...
class HttpBinding implements BindingInterface
{
     ...
     *
     * It differs from the command because Doctrine\Orient defines a query as a SELECT only.
     *
     * @api
