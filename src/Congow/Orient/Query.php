...
/**
 * Query class to build queries execute by an Congow\OrientDB's protocol adapter.
 *
...
use Congow\Orient\Query\Command\Credential\Grant;
...
use Congow\Orient\Contract\Query\Command\Grant as GrantInterface;
use Congow\Orient\Contract\Query\Command\Revoke as RevokeInterface;
