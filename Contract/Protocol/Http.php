...
interface Http
{
    ...
    /**
     * Opens a connection to an OrientDB $database.
     *
     * @param   string  $database
     * @return  mixed
     */
    ...
    /**
     * Disconnects the client from the OrientDB database, if any connection
     * is still open.
     *
     * @return  mixed
     */
    ...
    /**
     * Retrieves informations about the running OrientDB server instance.
     *
     * @return  mixed
     */
     ...
     * Since almost all the methods exposed by OrientDB HTTP interface let you
