...
namespace Orient\Foundation\Protocol\Adapter;

use Orient\Contract\Protocol\Adapter as ProtocolAdapter;
...
class Http implements protocolAdapter
{
    ...
    /**
     * Executes a command against OrientDB via the HTTP binding.
     *
     * @param   type $command
     * @return  mixed
     * @throws  \Exception
